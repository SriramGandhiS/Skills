...
| FAIL: Directional (breaks in RTL) | PASS: Logical (works in both) |
|---|---|
...
|---|---|
| Latin (English, French, German...) | PASS: Most web fonts |
| Cyrillic (Russian, Bulgarian...) | PASS: Many Google Fonts |
| Greek | PASS: Many Google Fonts |
| Arabic | FAIL: Most Latin web fonts — needs dedicated Arabic font |
| Hebrew | FAIL: Most Latin web fonts — needs dedicated Hebrew font |
| CJK (Chinese, Japanese, Korean) | FAIL: Most Latin web fonts — system fonts usually |
| Devanagari (Hindi) | FAIL: Most Latin web fonts — Noto fonts or dedicated |
