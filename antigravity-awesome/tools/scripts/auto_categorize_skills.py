...
def auto_categorize(skills_dir, dry_run=False):
        ...
        if "SKILL.md" in files:
            ...
            try:
                ...
                try:
                    ...
                    print(f"WARNING: {skill_id}: YAML error - {e}")
                    continue
                ...
                print(f"FAIL: Error processing {skill_id}: {str(e)}")
    ...
    print("="*70)
    print(f"\n Summary:")
    print(f"   PASS: Categorized: {categorized_count}")
    print(f"   SKIPPED:  Already categorized: {already_categorized}")
    print(f"   FAIL: Failed to categorize: {failed_count}")
