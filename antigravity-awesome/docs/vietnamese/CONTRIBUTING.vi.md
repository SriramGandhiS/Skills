...
- PASS: File `SKILL.md` có tồn tại hay không.
- PASS: Phần Frontmatter có chính xác không.
- PASS: Tên (Name) có khớp với tên thư mục không.
- PASS: Có vượt qua các kiểm tra của Quality Bar không.
...
- PASS: **Nên:** [Thực hành tốt]
- FAIL: **Không nên:** [Điều cần tránh]
