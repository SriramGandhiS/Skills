...
- PASS: **Claude Code** (Dòng lệnh CLI của Anthropic)
- PASS: **Gemini CLI** (Google)
- PASS: **Codex CLI** (OpenAI)
- PASS: **Cursor** (IDE tích hợp AI)
- PASS: **Antigravity IDE**
- PASS: **OpenCode**
- WARNING: **GitHub Copilot** (Hỗ trợ một phần qua việc copy-paste)

### Những kỹ năng này có được sử dụng miễn phí không?

**Có!** Repository này được cấp phép theo giấy phép MIT License.

- PASS: Miễn phí cho sử dụng cá nhân.
- PASS: Miễn phí cho sử dụng thương mại.
- PASS: Bạn có thể sửa đổi chúng.
