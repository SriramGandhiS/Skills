...
- PASS: Nên làm điều này
- PASS: Cũng nên làm điều này
- FAIL: Không nên làm điều này
- FAIL: Tránh điều này
```
...
## PASS: Danh mục Kiểm tra Chất lượng (Quality Checklist)
...
- PASS: Tên rõ ràng.
- PASS: Mô tả mạnh mẽ với tính cấp bách ("PHẢI sử dụng").
- PASS: Giải thích khi nào nên dùng.
...
- PASS: Tiêu đề rõ ràng.
- PASS: Tổng quan súc tích.
- PASS: Giải thích giá trị mang lại.
...
- PASS: Được chia thành các giai đoạn rõ ràng.
- PASS: Các bước cụ thể, có thể hành động.
- PASS: Dễ dàng thực hiện theo.
