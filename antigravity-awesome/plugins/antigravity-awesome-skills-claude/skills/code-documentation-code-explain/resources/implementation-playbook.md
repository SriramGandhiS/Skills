...
### Benefits:
PASS: Controlled access to single instance
PASS: Reduced namespace pollution
PASS: Permits refinement of operations

### Drawbacks:
FAIL: Can make unit testing difficult
FAIL: Violates Single Responsibility Principle
FAIL: Can hide dependencies
