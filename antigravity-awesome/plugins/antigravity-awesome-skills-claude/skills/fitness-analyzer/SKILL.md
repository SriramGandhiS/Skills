...
### 警示
1. WARNING: 注意运动强度不宜过高，控制在中等强度为主
```
...
### 实践建议
1. PASS: 继续保持规律运动，每周5-7天
2. PASS: 每次运动30-60分钟，中等强度
3. PASS: 优先选择有氧运动（快走、慢跑、骑行）
4. WARNING: 避免憋气动作和突然爆发性运动
...
| 指标 | 开始 | 当前 | 改善 |
|------|------|------|------|
| 平均配速 | 7:30 min/km | 6:00 min/km | +20%  |
| 最快配速 | 7:00 min/km | 5:30 min/km | +22%  |
| 5公里用时 | 37:30 | 30:00 | +20%  |
...
| 指标 | 开始 | 当前 | 改善 |
|------|------|------|------|
| 最长单次距离 | 3 km | 12 km | +300%  |
| 月度总距离 | 40 km | 86 km | +115%  |
| 平均距离 | 5 km | 6 km | +20%  |
...
| 指标 | 开始 | 当前 | 改善 |
|------|------|------|------|
| 静息心率 | 78 bpm | 72 bpm | -6 bpm  |
| 相同配速心率 | 155 bpm | 145 bpm | -10 bpm  |

**分析**：心肺功能显著改善，相同配速下心率降低。

## 里程碑

- PASS: 2025-03-15：首次完成5公里跑
- PASS: 2025-05-20：首次完成10公里跑
- PASS: 2025-06-10：配速突破6:00 min/km
