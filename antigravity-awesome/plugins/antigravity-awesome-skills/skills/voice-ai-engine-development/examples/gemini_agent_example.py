...
class GeminiAgent:
    ...
    async def generate_response(
        ...
        try:
            ...
            logger.error(f"FAIL: [AGENT] Error generating response: {e}")
        ...
        if full_response.strip():
            ...
            logger.info(f"PASS: [AGENT] Generated complete response ({len(full_response)} chars)")
    ...
    def clear_conversation_history(self):
        ...
        logger.info(" [AGENT] Cleared conversation history")
