...
| FAIL: AI Default | Why It's Wrong | PASS: Mobile-Correct |
|---------------|----------------|-------------------|
...
|------|--------------|------------------|------------|
| **Back navigation** | Edge swipe | System back button | PASS: YES |
| **Permissions** | Ask once, settings | Ask each time, rationale | PASS: YES |
| **Keyboard** | Different appearance | Different behavior | PASS: YES |
| **Date picker** | Wheel/modal | Material dialog | WARNING: If custom UI |
| **Push format** | APNs payload | FCM payload | PASS: YES |
| **Deep links** | Universal Links | App Links | PASS: YES |
| **Gestures** | Some unique | Material gestures | WARNING: If custom |
