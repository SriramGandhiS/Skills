...
- PASS: Correct: `<div><p>Text here</p></div>`
- FAIL: Wrong: `<div>Text here</div>` - **Text will NOT appear in PowerPoint**
- FAIL: Wrong: `<span>Text</span>` - **Text will NOT appear in PowerPoint**
- Text in `<div>` or `<span>` without a text tag will be silently ignored

**NEVER use manual bullet symbols (•, -, *, etc.)** - Use `<ul>` or `<ol>` lists instead

**ONLY use web-safe fonts that are universally available:**
- PASS: Web-safe fonts: `Arial`, `Helvetica`, `Times New Roman`, `Georgia`, `Courier New`, `Verdana`, `Tahoma`, `Trebuchet MS`, `Impact`, `Comic Sans MS`
- FAIL: Wrong: `'Segoe UI'`, `'SF Pro'`, `'Roboto'`, custom fonts - **Might cause rendering issues**
...
- PASS: Correct: `color: "FF0000"`, `fill: { color: "0066CC" }`
- FAIL: Wrong: `color: "#FF0000"` (breaks document)
