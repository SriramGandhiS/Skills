...
| **OpenCode** | Directory | FAIL: Manual | FAIL: None | None |
...
| `enhance` | Claude, Gemini, OpenAI | All | PASS: `--target` |
| `package` | All | All | PASS: `--target` |
| `upload` | Claude, Gemini, OpenAI | All | PASS: `--target` |
| `estimate` | All | Docs only | No (estimation is universal) |
| `install` | All | All | PASS: `--target` |
