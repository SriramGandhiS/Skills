...
**WARNING: Framework Status** (2026):
- PASS: **Supported**: SvelteKit, Astro, Nuxt, Qwik, Solid Start
- FAIL: **Deprecated**: Next.js (`@cloudflare/next-on-pages`), Remix (`@remix-run/cloudflare-pages`)
