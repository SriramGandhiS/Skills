...
| Read replicas | FAIL: Not available | PASS: Available | Paid add-on for lower latency |
| Sessions API | FAIL: Not available | PASS: Up to 15 min | For migrations and heavy operations |
