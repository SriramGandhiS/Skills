...
Patterns for building Clinical Decision Support Systems that integrate into EMR workflows. CDSS modules are patient safety critical â€” zero tolerance for false negatives.
...
CDSS Engine (pure functions, no side effects)
  ...
  â”œâ”€â”€ Dose Validator
  â”œâ”€â”€ Clinical Scoring (NEWS2, qSOFA, etc.)
  â””â”€â”€ Alert Classifier
  â†“ (returns alerts)
...
```typescript
describe('CDSS â€” Patient Safety', () => {
