...
1. **Via Plugin**: `/plugin install ecc@ecc` â€” the plugin loads this skill automatically
...
Options:
  - "User-level (~/.claude/)" â€” "Applies to all your Claude Code projects"
  - "Project-level (.claude/)" â€” "Applies only to the current project"
  - "Both" â€” "Common/shared items user-level, project-specific items project-level"
```
...
Options:
  - "Core only (recommended)" â€” "tdd, e2e, evals, verification, research-first, security, frontend patterns, compacting, cross-functional Anthropic skills"
  - "Core + selected niche" â€” "Add framework/domain-specific skills after core"
  - "Niche only" â€” "Skip core, install specific framework/domain skills"
Default: Core only
```
...
Options:
  - "Framework & Language" â€” "Django, Laravel, Spring Boot, Quarkus, Go, Python, Java, Frontend, Backend patterns"
  - "Database" â€” "PostgreSQL, ClickHouse, JPA/Hibernate patterns"
  - "Workflow & Quality" â€” "TDD, verification, learning, security review, compaction"
  - "Research & APIs" â€” "Deep research, Exa search, Claude API patterns"
  - "Social & Content Distribution" â€” "X/Twitter API, crossposting alongside content-engine"
  - "Media Generation" â€” "fal.ai image/video/audio alongside VideoDB"
  - "Orchestration" â€” "dmux multi-agent workflows"
  - "All skills" â€” "Install every available skill"
```
...
Options:
  - "Common rules (Recommended)" â€” "Language-agnostic principles: coding style, git workflow, testing, security, etc. (8 files)"
  - "TypeScript/JavaScript" â€” "TS/JS patterns, hooks, testing with Playwright (5 files)"
  - "Python" â€” "Python patterns, pytest, black/ruff formatting (5 files)"
  - "Go" â€” "Go patterns, table-driven tests, gofmt/staticcheck (5 files)"
```
...
Options:
  - "Optimize skills" â€” "Remove irrelevant sections, adjust paths, tailor to your tech stack"
  - "Optimize rules" â€” "Adjust coverage targets, add project-specific patterns, customize tool configs"
  - "Optimize both" â€” "Full optimization of all installed files"
  - "Skip" â€” "Keep everything as-is"
```
