...
- Before major refactoring â€” identify what's core, what's duplicate, what's dead
...
| **Library detection** | 50+ known libraries (FFmpeg, Boost, OpenSSLâ€¦) with version extraction |
